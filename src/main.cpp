...
uint256 hashGenesisBlock("0xe22bf0c0e09a7b6e0b61881e62a5cf5eb9a7e523880a3237b49db5bb9d39db49");
...
const string strMessageMagic = "vaccercoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // : 1 days
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal vaccercoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vaccercoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x17e0dff8dc2d80c5d2faec3f7082e70311680f5bda416e1508bae3a774a72b77");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "10th of june 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1434201979; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1581617;

        if (fTestNet)
        {
            block.nTime    = 1434113788;
            block.nNonce   = 1296184;
        }
        ...
        assert(block.hashMerkleRoot == uint256("15ba661ed2bae3208fcb397c1d5eeae3686480c57a80433c54c78936406bbc46"));
